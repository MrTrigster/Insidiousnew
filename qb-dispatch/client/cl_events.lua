...
local function InjuriedPerson()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Isik Haavatud", -- message
...
local function DeceasedPerson()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Isik Surnud", -- message
        job = {"ambulance"} -- jobs that will get the alerts
    })
...
local function StoreRobbery()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Poe Alarm", -- message
...
local function FleecaBankRobbery()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Pangarööv (Fleeca)", -- message
        job = {"police"} -- jobs that will get the alerts
    })
...
local function PaletoBankRobbery()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Pangarööv (Paleto)", -- message
        job = {"police"} -- jobs that will get the alerts
    })
...
local function PacificBankRobbery()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Pangarööv (Pacific)", -- message
        job = {"police"} -- jobs that will get the alerts
    })
...
local function VangelicoRobbery()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Juveelipoe Alarm", -- message
        job = {"police"} -- jobs that will get the alerts
    })
...
local function HouseRobbery()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Maja Alarm", -- message
        job = {"police"} -- jobs that will get the alerts
    })
...
local function DrugSale()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Kahtlane Tehing", -- message
        job = {"police"} -- jobs that will get the alerts
    })
...
local function Explosion()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Plahvatus", -- message
        job = {"police"} -- jobs that will get the alerts
    })
end exports('Explosion', Explosion)

local function CokePlane()
    local currentPos = GetEntityCoords(PlayerPedId())
    local locationInfo = getStreetandZone(currentPos)
    local gender = GetPedGender()
    TriggerServerEvent("dispatch:server:notify",{
        dispatchcodename = "cokeplane", -- has to match the codes in sv_dispatchcodes.lua so that it generates the right blip
        dispatchCode = "10-80",
        firstStreet = locationInfo,
        gender = nil,
        model = nil,
        ...
        dispatchMessage = "Tundmatu Lennuk", -- message
        job = {"police"} -- jobs that will get the alerts
    })
end exports('CokePlane', CokePlane)

local function CookingMeth()
    local currentPos = GetEntityCoords(PlayerPedId())
    local locationInfo = getStreetandZone(currentPos)
    local gender = GetPedGender()
    TriggerServerEvent("dispatch:server:notify",{
        dispatchcodename = "cookingmeth", -- has to match the codes in sv_dispatchcodes.lua so that it generates the right blip
        dispatchCode = "10-16",
        firstStreet = locationInfo,
        gender = nil,
        model = nil,
        ...
        dispatchMessage = "Kahtlane Tossav Sõiduk", -- message
        job = {"police"} -- jobs that will get the alerts
    })
end exports('CookingMeth', CookingMeth)

RegisterNetEvent("i13-dispatch:client:officerdown", function()
...
RegisterNetEvent("i13-dispatch:client:emsdown", function()
    local plyData = QBCore.Functions.GetPlayerData()
    local currentPos = GetEntityCoords(PlayerPedId())
    local locationInfo = getStreetandZone(currentPos)
    local callsign = QBCore.Functions.GetPlayerData().metadata["callsign"]
