...
Config.Shops = {
    [1] = {
        category = 'import', -- Change ["shop"] in qb-core/shared.lua to match this for the vehicles you want
        coords = vector3(-56.49, -1096.58, 26.42), -- For Marker
        spawnvehicle = vector4(-147.48, -597.57, 166.57, 86.18), -- Display Point
        cameracoords = vector3(-150.32, -591.5, 167.59), -- Where To Create Camera
        pointcamera = vector3(-147.64, -597.41, 166.31), -- Where To Point Camera
        buyspawn = vector4(-147.48, -597.57, 166.57, 86.18), -- Where Vehicle Spawns on Buy
        testdrive = vector4(-147.48, -597.57, 166.57, 86.18) -- Where Vehicle Spawns on Test Drive
    },
    -- [2] = {
    --     category = 'police',
