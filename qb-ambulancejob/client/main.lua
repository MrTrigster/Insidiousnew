...
BodyParts = {
    ['HEAD'] = { label = 'pea', causeLimp = false, isDamaged = false, severity = 0 },
    ['NECK'] = { label = 'kael', causeLimp = false, isDamaged = false, severity = 0 },
    ['SPINE'] = { label = 'selgroog', causeLimp = true, isDamaged = false, severity = 0 },
    ['UPPER_BODY'] = { label = 'ülakeha', causeLimp = false, isDamaged = false, severity = 0 },
    ['LOWER_BODY'] = { label = 'alakeha', causeLimp = true, isDamaged = false, severity = 0 },
    ['LARM'] = { label = 'vasak käevars', causeLimp = false, isDamaged = false, severity = 0 },
    ['LHAND'] = { label = 'vasak käsi', causeLimp = false, isDamaged = false, severity = 0 },
    ['LFINGER'] = { label = 'vasakud sõrmed', causeLimp = false, isDamaged = false, severity = 0 },
    ['LLEG'] = { label = 'vasak jalg', causeLimp = true, isDamaged = false, severity = 0 },
    ['LFOOT'] = { label = 'vasak jalalaba', causeLimp = true, isDamaged = false, severity = 0 },
    ['RARM'] = { label = 'parem käevars', causeLimp = false, isDamaged = false, severity = 0 },
    ['RHAND'] = { label = 'parem käsi', causeLimp = false, isDamaged = false, severity = 0 },
    ['RFINGER'] = { label = 'paremad sõrmed', causeLimp = false, isDamaged = false, severity = 0 },
    ['RLEG'] = { label = 'parem jalg', causeLimp = true, isDamaged = false, severity = 0 },
    ['RFOOT'] = { label = 'parem jalalaba', causeLimp = true, isDamaged = false, severity = 0 },
}

WeaponDamageList = {
	["WEAPON_UNARMED"] = "Rusikajäljed",
	["WEAPON_ANIMAL"] = "Loomahammustus",
	["WEAPON_COUGAR"] = "Loomahammustus",
	["WEAPON_KNIFE"] = "Noahaav",
	["WEAPON_NIGHTSTICK"] = "Relvalöögist muhk",
	["WEAPON_BREAD"] = "Dent in your head from a baguette!",
	["WEAPON_HAMMER"] = "Relvalöögist muhk",
	["WEAPON_BAT"] = "Relvalöögist muhk",
	["WEAPON_GOLFCLUB"] = "Relvalöögist muhk",
	["WEAPON_CROWBAR"] = "Relvalöögist muhk",
	["WEAPON_PISTOL"] = "Püstoli kuulid keres",
	["WEAPON_COMBATPISTOL"] = "Püstoli kuulid keres",
	["WEAPON_APPISTOL"] = "Püstoli kuulid keres",
	["WEAPON_PISTOL50"] = "Püstoli kuulid keres",
	["WEAPON_MICROSMG"] = "SMG kuulid keres",
	["WEAPON_SMG"] = "SMG kuulid keres",
	["WEAPON_ASSAULTSMG"] = "SMG kuulid keres",
	["WEAPON_ASSAULTRIFLE"] = "Rifle kuulid keres",
	["WEAPON_CARBINERIFLE"] = "Rifle kuulid keres",
	["WEAPON_ADVANCEDRIFLE"] = "Rifle kuulid keres",
	["WEAPON_MG"] = "MG kuulid keres",
	["WEAPON_COMBATMG"] = "MG kuulid keres",
	["WEAPON_PUMPSHOTGUN"] = "Shotguni kuulid keres",
	["WEAPON_SAWNOFFSHOTGUN"] = "Shotguni kuulid keres",
	["WEAPON_ASSAULTSHOTGUN"] = "Shotguni kuulid keres",
	["WEAPON_BULLPUPSHOTGUN"] = "Shotguni kuulid keres",
	["WEAPON_STUNGUN"] = "Taseri haav",
	["WEAPON_SNIPERRIFLE"] = "Sniperi kuulid keres",
	["WEAPON_HEAVYSNIPER"] = "Sniperi kuulid keres",
	["WEAPON_REMOTESNIPER"] = "Sniperi kuulid keres",
	["WEAPON_GRENADELAUNCHER"] = "Põletushaavad ja killud",
	["WEAPON_GRENADELAUNCHER_SMOKE"] = "Suitsukahjustus",
	["WEAPON_RPG"] = "Põletushaavad ja killud",
	["WEAPON_STINGER"] = "Põletushaavad ja killud",
	["WEAPON_MINIGUN"] = "Very much bullets in the body",
	["WEAPON_GRENADE"] = "Põletushaavad ja killud",
	["WEAPON_STICKYBOMB"] = "Põletushaavad ja killud",
	["WEAPON_SMOKEGRENADE"] = "Suitsukahjustus",
	["WEAPON_BZGAS"] = "Gaasikahjustus",
	["WEAPON_MOLOTOV"] = "Tugevad põletushaavad",
	["WEAPON_FIREEXTINGUISHER"] = "Tulekustuti jäljed",
	["WEAPON_PETROLCAN"] = "Kütuse kanistri haavad",
	["WEAPON_FLARE"] = "Põletushaavad",
	["WEAPON_BARBED_WIRE"] = "Okastraadi haavad",
	["WEAPON_DROWNING"] = "Vesi kopsudes",
	["WEAPON_DROWNING_IN_VEHICLE"] = "Vesi kopsudes",
	["WEAPON_BLEEDING"] = "Suur verekaotus",
	["WEAPON_ELECTRIC_FENCE"] = "Elektrilöök",
	["WEAPON_EXPLOSION"] = "Põletushaavad (plahvatusest)",
	["WEAPON_FALL"] = "Murtud luud",
	["WEAPON_EXHAUSTION"] = "Üleväsimus",
	["WEAPON_HIT_BY_WATER_CANNON"] = "Löögihaavad (veekahur)",
	["WEAPON_RAMMED_BY_CAR"] = "Auto avarii",
	["WEAPON_RUN_OVER_BY_CAR"] = "Sai autoga pihta",
	["WEAPON_HELI_CRASH"] = "Helikopteri õnnetus",
	["WEAPON_FIRE"] = "Põletushaavad",
}
        ...
        if #injured > 0 then
            ...
            if #injured <= Config.AlertShowInfo then
                for k, v in pairs(injured) do
                    limbDamageMsg = limbDamageMsg .. "Sinu " .. v.label .. " tekitab sulle "..Config.WoundStates[v.severity]
                    if k < #injured then
                        limbDamageMsg = limbDamageMsg .. " | "
                    end
                end
            else
                limbDamageMsg = "Sul on valu mitmes kohas"
            end
...
local function DoBleedAlert()
    if not isDead and tonumber(isBleeding) > 0 then
        QBCore.Functions.Notify("Sul on "..Config.BleedingStates[tonumber(isBleeding)].label, "error", 5000)
    end
end
...
RegisterNetEvent('hospital:client:Revive', function()
    ...
    QBCore.Functions.Notify("Oled täiesti terve")
end)
...
RegisterNetEvent('hospital:client:HealInjuries', function(type)
    ...
    TriggerServerEvent("hospital:server:RestoreWeaponDamage")
    QBCore.Functions.Notify("Sinu haavad on ravitud")
end)
...
RegisterNetEvent('hospital:client:SendToBed', function(id, data, isRevive)
    ...
    CreateThread(function ()
        Wait(5)
        if isRevive then
            QBCore.Functions.Notify("Sind aidatakse")
...
CreateThread(function()
    while true do
        ...
        if isInHospitalBed and canLeaveBed then
            sleep = 5
            local pos = GetEntityCoords(PlayerPedId())
            -- DrawText3D(pos.x, pos.y, pos.z, "~g~E~w~ - Tõuse Püsti")
            exports['qb-drawtext']:DrawText('[E] - Tõuse Püsti', 'left')
        ...
        if LocalPlayer.state['isLoggedIn'] then
            ...
            for k, checkins in pairs(Config.Locations["checking"]) do
                if #(pos - checkins) < 1.5 then
                    ...
                    if doctorCount >= Config.MinimalDoctors then
                        -- DrawText3D(checkins.x, checkins.y, checkins.z, "~g~E~w~ - Kutsu Arst")
                        text = '[E] - Kutsu Arst'
                    else
                        ...
                        if doctorCount >= Config.MinimalDoctors then
                            ...
                            QBCore.Functions.Progressbar("hospital_checkin", "Check in...", 2000, false, true, {
                                ...
                                if bedId then
                                    ...
                                    QBCore.Functions.Notify("Voodikohad on täis", "error")
                                end
                            end, function() -- Cancel
                                TriggerEvent('animations:client:EmoteCommandStart', {"c"})
            ...
            if closestBed and not isInHospitalBed then
                if #(pos - vector3(Config.Locations["beds"][closestBed].coords.x, Config.Locations["beds"][closestBed].coords.y, Config.Locations["beds"][closestBed].coords.z)) < 2 then
                    sleep = 7
                    inRange = true
                    -- DrawText3D(Config.Locations["beds"][closestBed].coords.x, Config.Locations["beds"][closestBed].coords.y, Config.Locations["beds"][closestBed].coords.z + 0.3, "~g~E~w~ - Lama Voodis")
                    text = '[E] - Lama Voodis'
                    if IsControlJustReleased(0, 38) then
                        if GetAvailableBed(closestBed) then
                            TriggerServerEvent("hospital:server:SendToBed", closestBed, false)
                        else
                            QBCore.Functions.Notify("Voodid on hõivatud", "error")
                        end
                    end
                end
            end
