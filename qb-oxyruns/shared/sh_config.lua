...
Config.StartLocation = vector4(-622.96, 311.69, 83.93, 196.83) -- Start location for oxy run
...
Config.MinCops = 1 -- Minimum required amount of cops
Config.CallCopsChance = 60 -- %Chance to alert police

Config.LaunderChance = 80 -- %Chance to launder money
Config.LaunderItem = 'cash_roll'

Config.OxyChance = 35 -- %Chance to receive oxy
Config.OxyItem = 'oxy'

Config.RareLoot = 1 -- %Chance to receive a rare loot item
Config.RareLootItem = 'cryptostick' -- Rare loot item
