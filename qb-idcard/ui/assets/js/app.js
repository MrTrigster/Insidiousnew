...
//   $('.qb-idcard').addClass('slide-in');
  const person = {Name: idcard.data.information.name,Lastname: idcard.data.information.lastname,Dob: idcard.data.information.dob,Nationality: idcard.data.information.nationality, Sex: idcard.data.information.gender};
  switch (idcard.data.nui) {
      ...
      case 'pilotlicense':
          ...
          $('#sex').html('PPL');
          $("#lang-nat").css('display','none');
          $('.qb-idcard').css('background', QB.Pilotlicense.background);
          break;
      case 'weaponlicense':
...
document.onkeyup = function(event) {
    ...
    if (event.key === 'Escape' || event.key === 'Backspace' ) { // Nui hide key backspace
