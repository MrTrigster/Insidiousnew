...
local function CreateApartmentFurnished(spawn)
	local objects = {}
    local POIOffsets = {}
	POIOffsets.exit = json.decode('{"x": 3.9, "y": 3.35, "z": 1.3, "h":0.28}')
	POIOffsets.clothes = json.decode('{"x": -0.10, "y": -2.4, "z": 1.5, "h":2.263}')
	POIOffsets.stash = json.decode('{"x": -0.25, "y": 1.9, "z": 0.5, "h":2.263}')
	POIOffsets.logout = json.decode('{"x": -4.65, "y": -2.85, "z": 1.0, "h":2.263}')
    DoScreenFadeOut(500)
