...
local function IsWearingNVG()
    local ped = PlayerPedId()
    local nvg = GetPedPropIndex(ped, 0)
    local model = GetEntityModel(ped)
    local retval = false
    if model == `mp_m_freemode_01` then
        if nvg ~= nil and nvg == 116 then
            retval = true
        end
    else
        if nvg ~= nil and nvg == 115 then
            retval = true
        end
    end
    return retval
...
RegisterNetEvent('consumables:client:UseJoint', function()
    QBCore.Functions.Progressbar("smoke_joint", "Tõmbab jointi...", 1500, false, true, {
...
RegisterNetEvent('consumables:client:UseParachute', function()
    EquipParachuteAnim()
    QBCore.Functions.Progressbar("use_parachute", "Kasutab langevarju...", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('consumables:client:ResetParachute', function()
    if ParachuteEquiped then 
        EquipParachuteAnim()
        QBCore.Functions.Progressbar("reset_parachute", "Eemaldab langevarju...", 30000, false, true, {
            disableMovement = false,
            disableCarMovement = false,
            disableMouse = false,
            disableCombat = true,
        ...
        QBCore.Functions.Notify("Sul ei ole langevarju", "error")
    end
end)
...
RegisterNetEvent('consumables:client:UseArmor', function()
    if GetPedArmour(PlayerPedId()) >= 50 then QBCore.Functions.Notify('Sul on juba piisavalt armorit', 'error') return end
    QBCore.Functions.Progressbar("use_armor", "Paneb kuulivesti selga...", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('consumables:client:UseHeavyArmor', function()
    if GetPedArmour(PlayerPedId()) == 100 then QBCore.Functions.Notify('Sul on juba piisavalt armorit', 'error') return end
    local ped = PlayerPedId()
    local PlayerData = QBCore.Functions.GetPlayerData()
    QBCore.Functions.Progressbar("use_heavyarmor", "Paneb kuulivesti selga...", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('consumables:client:ResetArmor', function()
    ...
    if currentVest ~= nil and currentVestTexture ~= nil then 
        QBCore.Functions.Progressbar("remove_armor", "Eemaldab kuulivesti...", 2500, false, true, {
            disableMovement = false,
            disableCarMovement = false,
            disableMouse = false,
            disableCombat = true,
        ...
        QBCore.Functions.Notify("Sul ei ole kuulivesti seljas", "error")
    end
end)

RegisterNetEvent('consumables:client:UseNVG', function()
    local ped = PlayerPedId()
    local model = GetEntityModel(ped)
    if model == `mp_m_freemode_01` then
        if IsWearingNVG() then
            ClearPedProp(ped, 0)
        ...
        if IsWearingNVG() then
            ...
            SetPedPropIndex(ped, 0, 115, 0, true)
            SetNightvision(true)
        end
    end
end)
...
RegisterNetEvent('consumables:client:DrinkAlcohol', function(itemName)
    ...
    QBCore.Functions.Progressbar("snort_coke", "Joob alkoholi...", math.random(3000, 6000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('consumables:client:Cokebaggy', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("snort_coke", "Tõmbab kokat...", math.random(5000, 8000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('consumables:client:Crackbaggy', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("snort_coke", "Tõmbab cracki...", math.random(7000, 10000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('consumables:client:oxy', function()
    QBCore.Functions.Progressbar("use_oxy", "Võtab Oxy't...", 2000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('consumables:client:meth', function()
    QBCore.Functions.Progressbar("snort_meth", "Tõmbab methi...", 1500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('consumables:client:Eat', function(itemName)
    ...
    QBCore.Functions.Progressbar("eat_something", "Sööb...", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('consumables:client:Drink', function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"drink"})
    QBCore.Functions.Progressbar("drink_something", "Joob...", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
