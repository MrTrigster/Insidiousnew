            ...
            if (ItemData.name.split("_")[0] == "weapon") {
                if (!$("#weapon-attachments").length) {
                    ...
                    $(".inv-options-list").append(
                        '<div class="inv-option-item" id="weapon-attachments"><p>Attachmentid</p></div>'
                    );
    ...
    $.post(
        ...
        function(data) {
            ...
            $(".weapon-attachments-container-details").html(
                '<span style="font-weight: bold; letter-spacing: .1vh;">Seerianumber</span><br> ' +
            ...
            if (data.AttachmentData !== null && data.AttachmentData !== undefined) {
                if (data.AttachmentData.length > 0) {
                    $(".weapon-attachments-title").html(
                        '<span style="font-weight: bold; letter-spacing: .1vh;">Attachmentid</span>'
                    );
                    ...
                    $(".weapon-attachments-title").html(
                        '<span style="font-weight: bold; letter-spacing: .1vh;">Sellel relval ei ole attachmente</span>'
                    );
                }
            } else {
                $(".weapon-attachments-title").html(
...
$(document).on("click", "#weapon-attachments", function(e) {
    ...
    if (!Inventory.IsWeaponBlocked(ClickedItemData.name)) {
        ...
        $.post(
            ...
            JSON.stringify({
                message: "Sellele relvale ei ole attachmente",
                type: "error",
            })
        );
    }
    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                "<p><strong>Isikukood: </strong><span>" +
                itemData.info.citizenid +
                "</span></p><p><strong>Eesnimi: </strong><span>" +
                itemData.info.firstname +
                "</span></p><p><strong>Perekonnanimi: </strong><span>" +
                itemData.info.lastname +
                "</span></p><p><strong>Sünnikuupäev: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>Sugu: </strong><span>" +
                gender +
                "</span></p><p><strong>Rahvus: </strong><span>" +
            ...
            $(".item-info-description").html(
                "<p><strong>Omaniku Telefoninumber: </strong><span>" +
                ...
                itemData.info.level +
                "</span></p><p><strong>Vanus: </strong><span>" +
                callAge(itemData.info.age) +
                "</span></p><p><strong>Toit: </strong><span>" +
                itemData.info.food +
                "</span></p>"
            );
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Eesnimi: </strong><span>" +
                itemData.info.firstname +
                "</span></p><p><strong>Perekonnanimi: </strong><span>" +
                itemData.info.lastname +
                "</span></p><p><strong>Sünnikuupäev: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>Load: </strong><span>" +
                itemData.info.type +
                "</span></p>"
            );
        } else if (itemData.name == "pilot_license") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Eesnimi: </strong><span>" +
                itemData.info.firstname +
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>Perekonnanimi: </strong><span>" +
                itemData.info.lastname +
                "</span></p><p><strong>Isikukood: </strong><span>" +
                itemData.info.citizenid +
                "</span></p>"
            );
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p>" + itemData.info.uses + " kasutust jäänud.</p>"
            );
            ...
            if (itemData.info.attachments != null) {
                ...
                $(".item-info-description").html(
                    "<p><strong>Seerianumber: </strong><span>" +
                    itemData.info.serie +
                    "</span></p><p><strong>Kuulid: </strong><span>" +
                    itemData.info.ammo +
                    "</span></p><p><strong>Attachmentid: </strong><span>" +
                    attachmentString +
                    "</span></p>"
                );
            } else {
            ...
            if (itemData.info.type == "casing") {
                $(".item-info-description").html(
                    "<p><strong>Asitõendi tüüp: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Tüübi nr: </strong><span>" +
                    itemData.info.ammotype +
                    "</span></p><p><strong>Kaliiber: </strong><span>" +
                    itemData.info.ammolabel +
                    "</span></p><p><strong>Seerianumber: </strong><span>" +
                    itemData.info.serie +
                    "</span></p><p><strong>Sündmuskoht: </strong><span>" +
                ...
                $(".item-info-description").html(
                    "<p><strong>Asitõendi tüüp: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Veretüüp: </strong><span>" +
                    itemData.info.bloodtype +
                    "</span></p><p><strong>DNA Kood: </strong><span>" +
                ...
                $(".item-info-description").html(
                    "<p><strong>Asitõendi tüüp: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Sõrmejälg: </strong><span>" +
            ...
            $(".item-info-title").html('<p>' + itemData.label + '</p>')
            $(".item-info-description").html('<p><strong>Eesnimi: </strong><span>'+ itemData.info.firstname + '</span></p><p><strong>Perekonnanimi: </strong><span>'+ itemData.info.lastname +'</span></p><p><strong>Numbrimärk: </strong><span>'+ itemData.info.plate + '<p><strong>Mudel: </strong><span>'+ itemData.info.model +'</span></p>');
        } else if (itemData.name == "moneybag") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Rahasumma: </strong><span>$" +
                itemData.info.cash +
                "</span></p>"
            );
            ...
            if (fromData.amount == $toAmount) {
                ...
                //if (newData.name.split("_")[0] == "weapon") {
                    //if (!Inventory.IsWeaponBlocked(newData.name)) {
                        ...
                        var QualityColor = "rgb(220, 20, 60)";
                        if (newData.info.quality < 25) {
                            QualityColor = "rgb(191, 32, 32)";
                        } else if (newData.info.quality > 25 && newData.info.quality < 50) {
                            QualityColor = "rgb(220, 20, 60)";
                    ...
                    $.post(
                        ...
                        function(item) {
                            $(".combine-option-text").html(
                                "<p>Kui sa kombineerid need, siis sa saad: <b>" +
                                item.label +
                                "</b></p>"
                            );
                        }
...
(() => {
    ...
    Inventory.UseItem = function(data) {
        ...
        $("#itembox-action").html("<p>Kasutasid 1x</p>");
        ...
        if (data.toggle) {
            if (!requiredItemOpen) {
                ...
                $.each(data.items, function(index, item) {
                    var element =
                        '<div class="requiredItem-box"><div id="requiredItem-action">Vajalik</div><div id="requiredItem-label"><p>' +
                        item.label +
    ...
    window.onload = function(e) {
        window.addEventListener("message", function(event) {
            switch (event.data.action) {
                ...
                case "RobMoney":
                    $(".inv-options-list").append(
                        '<div class="inv-option-item" id="rob-money"><p>VÕTA RAHA</p></div>'
                    );
