...
Config.Rewards = {
    [1] = {
        ["cabin"] = {"diamond_ring", "goldchain", "weed_skunk", "cryptostick", "weapon_bat"},
        ["kitchen"] = {"ruby_ring", "sandwich", "goldchain"},
        ["chest"] = {"rolex", "diamond_ring", "goldchain", "weed_skunk", "cryptostick", "10kgoldchain"},
        ["livingroom"] = {"rolex", "diamond_ring", "goldchain", "cryptostick", "pistol_ammo"}
    }
}
