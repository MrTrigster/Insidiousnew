const Targeting = Vue.createApp({
    data() {
        return {
            ...
            SuccessColor: "#dc143c", // This is the color when the target has found the option
            StandardColor: "#eee", // This is the standard color, change this to the same as the StandardColor if you have changed it
