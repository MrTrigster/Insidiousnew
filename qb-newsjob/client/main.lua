...
function MenuHeliGarage()
    local vehicleMenu = {
        {
            header = "Weazel News Helikopterid",
            isMenuHeader = true
        }
    }
...
--                             DrawText3D(Config.Locations["vehicle"].coords.x, Config.Locations["vehicle"].coords.y, Config.Locations["vehicle"].coords.z, "~g~E~w~ - Pane Garaazi")
--                         else
--                             DrawText3D(Config.Locations["vehicle"].coords.x, Config.Locations["vehicle"].coords.y, Config.Locations["vehicle"].coords.z, "~g~E~w~ - Sõidukid")
--                         end
...
--                 --         if IsPedInAnyVehicle(PlayerPedId(), false) then
--                 --             DrawText3D(Config.Locations["heli"].coords.x, Config.Locations["heli"].coords.y, Config.Locations["heli"].coords.z, "~g~E~w~ - Tagasta")
--                 --         else
--                 --             DrawText3D(Config.Locations["heli"].coords.x, Config.Locations["heli"].coords.y, Config.Locations["heli"].coords.z, "~g~E~w~ - Helikopterid")
--                 --         end
--                 --         if IsControlJustReleased(0, 38) then
--                 --             if IsPedInAnyVehicle(PlayerPedId(), false) then
--                 --                 DeleteVehicle(GetVehiclePedIsIn(PlayerPedId()))
