...
function LoadGetNotes(){
    ...
    $(".documents-select span").html("<span>Vali Note</span>");

    var AddOption = '<div class="casino-text-clear">Siin ei ole midagi!</div>'+
...
$(document).on('click', '#documents-click-for-data', function(e){
    ...
    var AddOption = '<div class="document-body-class-body-main">'+
                        '<div class="document-body-class-title"><b>Pealkiri: </b>'+DocEndtitle+'</div>'+
                        '<textarea id="documents-textarea-new" spellcheck="false" required placeholder="Tekst" maxlength="300">'+DocEndtext+'</textarea>'+
