...
RegisterNetEvent('dispatch:manageNotifs', function(sentSetting)
    ...
    if wantedSetting == "on" then
        ...
        QBCore.Functions.Notify("Dispatch sisselülitatud", "success")
    elseif wantedSetting == "off" then
        disableNotis = true
        disableNotifSounds = true
        QBCore.Functions.Notify("Dispatch väljalülitatud", "success")
    elseif wantedSetting == "mute" then
        disableNotis = false
        disableNotifSounds = true
        QBCore.Functions.Notify("Dispatch mutetud", "success")
    else
        QBCore.Functions.Notify('Vali dispatch kas "on", "off" või "mute".', "success")
    end
end)
...
RegisterNetEvent("i13-dispatch:client:AddCallBlip")
AddEventHandler("i13-dispatch:client:AddCallBlip", function(coords, data)
...
RegisterNetEvent("i13-dispatch:client:Explosion", function(data)
