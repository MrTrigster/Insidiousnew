...
$('.cityhall-option-block').click(function(e){
    ...
    if (blockPage == "identity") {
        ...
        $(".identity-page-blocks").html('<div class="identity-page-block" data-type="id_card"><p>ID Kaart</p></div>');
...
$(document).on("click", ".identity-page-block", function(e){
    ...
    if (selectedIdentity == null) {
        ...
        if (idType == "id_card") {
            ...
            $(".request-identity-button").html("<p>Osta $50</p>")
        } else if (idType == "driver_license") {
            $(".request-identity-button").fadeIn(100);
            $(".request-identity-button").html("<p>Osta $50</p>")
        } else if (idType == "pilot_license") {
            $(".request-identity-button").fadeIn(100);
            $(".request-identity-button").html("<p>Osta $50</p>")
