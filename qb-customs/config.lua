...
bennyGarages = {
    [1] = {coords = vector3(136.12, -3030.58, 6.42), heading = 179.9, useJob = false, job = {"mechanic"}},
    [2] = {coords = vector3(144.8, -3030.35, 6.42), heading = 180.51, useJob = false, job = {"mechanic"}},
}
...
vehicleCustomisationPrices = {
    cosmetics = {price = 599},
    respray = {price = 459},
    performance = {prices = {0, 3000, 7000, 11000, 17000, 25000}},
    turbo = {price = 30000},
    wheels = {price = 399},
    customwheels = {price = 469},
    wheelsmoke = {price = 399},
    windowtint = {price = 499},
    neonside = {price = 199},
    neoncolours = {price = 299},
    headlights = {price = 199},
    xenoncolours = {price = 319},
    oldlivery = {price = 459},
    plateindex = {price = 169}
}
...
vehicleWheelOptions = {
    ...
    {category = "Bennys 1", id = 8, wheelID = 23},
    {category = "Bennys 2", id = 9, wheelID = 23},
    {category = "Formula", id = 10, wheelID = 23},
