...
Config.Locations = {
    ["checking"] = {
	    [1] = vector3(312.26, -592.78, 43.28),
    },
    ["duty"] = {
        [1] = vector3(311.14, -599.37, 43.29),
    },
    ["vehicle"] = {
        [1] = vector4(294.83, -574.13, 43.17, 43.1),
    },
    ["helicopter"] = {
        [1] = vector4(351.58, -587.45, 74.16, 160.5),
    },
    ["armory"] = {
        [1] = vector3(309.82, -602.71, 43.29),
    },
    ["roof"] = {
        [1] = vector4(338.5, -583.85, 65.16, 245.5),
    },
    ["main"] = {
        [1] = vector3(298.44, -599.7, 60.29),
    },
    ["beds"] = {
        [1] = {coords = vector4(322.6169, -587.1685, 42.84177, 340.00), taken = false, model = 1631638868},
        [2] = {coords = vector4(317.6706, -585.3683, 42.84177, 340.00), taken = false, model = 1631638868},
        [3] = {coords = vector4(314.4655, -584.2017, 42.84177, 340.00), taken = false, model = 1631638868},
        [4] = {coords = vector4(311.0575, -582.9613, 42.84177, 340.00), taken = false, model = 1631638868},
        [5] = {coords = vector4(307.7171, -581.7455, 42.84177, 340.00), taken = false, model = 1631638868},

        [6] = {coords = vector4(309.3536, -577.3783, 42.84177, 160.00), taken = false, model = 1631638868},
        [7] = {coords = vector4(313.9297, -579.0438, 42.84177, 160.00), taken = false, model = 1631638868},
        [8] = {coords = vector4(319.412, -581.0392, 42.84177, 160.00), taken = false, model = 1631638868},
        [9] = {coords = vector4(324.2628, -582.8009, 42.84177, 160.00), taken = false, model = 1631638868},
    },
    ["stations"] = {
        [1] = {label = "Pillbox Haigla", coords = vector4(304.27, -600.33, 43.28, 272.249)}
    }
}
...
Config.BleedingStates = {
    [1] = {label = 'väike verejooks', damage = 10, chance = 50},
    [2] = {label = 'verejooks', damage = 15, chance = 65},
    [3] = {label = 'suur verejooks', damage = 20, chance = 65},
    [4] = {label = 'tõsine verejooks', damage = 25, chance = 75},
}
