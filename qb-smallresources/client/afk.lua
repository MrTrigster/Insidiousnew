                ...
                if prevPos ~= nil then
                    if currentPos == prevPos then
                        if time ~= nil then
                            if time > 0 then
                                if time == (900) then
                                    QBCore.Functions.Notify('Sa oled AFK, sind kickitakse ' .. math.ceil(time / 60) .. ' minuti pärast', 'error', 10000)
                                ...
                                elseif time == (60) then
                                    QBCore.Functions.Notify('Sa oled AFK, sind kickitakse ' .. math.ceil(time / 60) .. ' minuti pärast', 'error', 10000) 
                                elseif time == (30) then
                                    QBCore.Functions.Notify('Sa oled AFK, sind kickitakse ' .. time .. ' sekundi pärast', 'error', 10000)  
                                elseif time == (20) then
                                    QBCore.Functions.Notify('Sa oled AFK, sind kickitakse ' .. time .. ' sekundi pärast', 'error', 10000)    
                                elseif time == (10) then
                                    QBCore.Functions.Notify('Sa oled AFK, sind kickitakse ' .. time .. ' sekundi pärast', 'error', 10000)                                                                                                            
