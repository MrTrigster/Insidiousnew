...
QB.Phone.Notifications.LoadTweets = function(Tweets) {
    ...
    if (Tweets !== null && Tweets !== undefined && Tweets !== "" && Tweets.length > 0) {
        ...
        $.each(Tweets, function(i, Tweet){
            ...
            var TimeAgo = moment(Tweet.date).format('L');
...
$(document).on('click', '#send-tweet', function(e){
    ...
    if (TweetMessage != "") {
        ...
        QB.Phone.Notifications.Add("fab fa-twitter", "Twitter", "Täida lüngad!", "#1DA1F2");
    };
    $('#tweet-new-url').val("");
...
function CopyMentionTag(elem) {
    ...
    QB.Phone.Notifications.Add("fab fa-twitter", "Twitter", $(elem).data('mentiontag')+ " kopeeritud!", "rgb(27, 149, 224)", 1250);
