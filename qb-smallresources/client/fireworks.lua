...
CreateThread(function()
    ...
    while true do
        ...
        if fireworkTime > 0 and fireworkLoc ~= nil then
            DrawText3Ds(fireworkLoc.x, fireworkLoc.y, fireworkLoc.z, "Ilutulestik läbi ~r~"..fireworkTime)
        end
    end
end)
...
AddEventHandler("fireworks:client:UseFirework", function(itemName, assetName)
    QBCore.Functions.Progressbar("spawn_object", "Paigaldab ilutulestikku...", 3000, false, true, {
