...
Config.DefaultColor = 'rgb(34, 40, 46)' -- The default color of the box of the popup text if Config.ChangeColor is false
...
Config.UnlockedColor = 'rgb(0 153 255)' -- The color of the box of the popup text if Config.ChangeColor is true and the door is unlocked
...
Config.DoorList = {
	...
	{
		objName = 'v_ilev_gb_vaubar',
		objCoords  = vec3(1172.291, 2713.146, 38.38625),
		textCoords = vec3(1172.291, 2713.146, 38.38625),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = true,
		distance = 2.0
