...
Citizen.CreateThread(function()
	...
	{ options = { { event = "jim-mining:SellOre", icon = "fas fa-certificate", label = "Müü Maaki", },	},
		distance = 2.0
	})
	--Jewel Cutting Bench
	exports['qb-target']:AddCircleZone("JewelCut", Config.Locations['JewelCut'].location, 2.0, { name="JewelCut", debugPoly=false, useZ=true, }, 
	{ options = { { event = "jim-mining:JewelCut", icon = "fas fa-certificate", label = "Kasuta Kalliskivi Lõikelauda", },	},
		distance = 2.0
	})
	--Jewel Buyer
	...
	{ options = { { event = "jim-mining:JewelSell", icon = "fas fa-certificate", label = "Müü Juveele", },	},
		distance = 2.0
	})
	--Cracking Bench
		...
		if hasTools then
			QBCore.Functions.TriggerCallback("jim-mining:Cutting:Check:"..data,function(hasReq) 
				if hasReq then 
					...
					loadAnimDict('amb@prop_human_parking_meter@male@idle_a')
					TaskPlayAnim(GetPlayerPed(-1), 'amb@prop_human_parking_meter@male@idle_a', 'idle_a' , 3.0, 3.0, -1, 1, 0, false, false, false)
					QBCore.Functions.Progressbar("open_locker_drill", "Lõikab...", math.random(10000,15000), false, true, {
						disableMovement = true, disableCarMovement = true,disableMouse = false,	disableCombat = true, }, {}, {}, {}, function() -- Done
						StopAnimTask(GetPlayerPed(-1), 'amb@prop_human_parking_meter@male@idle_a', 'idle_a', 1.0)
					...
					TriggerEvent('QBCore:Notify', "Sul ei ole kõiki koostisosi!", 'error')
					if data >= 1 and data <= 4 then TriggerEvent('jim-mining:JewelCut:Gem')
					elseif data >= 5 and data <= 9 then TriggerEvent('jim-mining:JewelCut:Ring')
					elseif data >= 10 and data <= 15 then TriggerEvent('jim-mining:JewelCut:Necklace') end
				end
			...
			TriggerEvent('QBCore:Notify', "Sul ei ole käsipuuri või puuriotsikut", 'error')
			if data >= 1 and data <= 4 then TriggerEvent('jim-mining:JewelCut:Gem')
			elseif data >= 5 and data <= 9 then TriggerEvent('jim-mining:JewelCut:Ring')
			elseif data >= 10 and data <= 15 then TriggerEvent('jim-mining:JewelCut:Necklace') end
		end
...
RegisterNetEvent('jim-mining:SellOre', function()
	exports['qb-menu']:openMenu({
		{ header = "Maagi Müümine", txt = "Müü üleliigset maaki", isMenuHeader = true },
		{ header = "Vasemaak", txt = "Müü $"..Config.SellItems['copperore'].." tükk", params = { event = "jim-mining:SellAnim", args = 'copperore' } },
		{ header = "Rauamaak", txt = "Müü $"..Config.SellItems['ironore'].." tükk", params = { event = "jim-mining:SellAnim", args = 'ironore' } },
		{ header = "Kullamaak", txt = "Müü $"..Config.SellItems['goldore'].." tükk", params = { event = "jim-mining:SellAnim", args = 'goldore' } },
		{ header = "Süsinik", txt = "Müü $"..Config.SellItems['carbon'].." tükk", params = { event = "jim-mining:SellAnim", args = 'carbon' } }, 
...
RegisterNetEvent('jim-mining:JewelSell', function()
    exports['qb-menu']:openMenu({
		{ header = "Juveeli Müügimees", txt = "Müü oma juveele siin", isMenuHeader = true }, 
		{ header = "Smaragdid", txt = "Smaragdi müügi valikud", params = { event = "jim-mining:JewelSell:Emerald", } },
		{ header = "Rubiinid", txt = "Rubiini müügi valikud", params = { event = "jim-mining:JewelSell:Ruby", } },
		{ header = "Teemantid", txt = "Teemanti müügi valikud", params = { event = "jim-mining:JewelSell:Diamond", } },
		{ header = "Safiirid", txt = "Safiiri müügi valikud", params = { event = "jim-mining:JewelSell:Sapphire", } },
		{ header = "Sõrmused", txt = "Sõrmuse müügi valikud", params = { event = "jim-mining:JewelSell:Rings", } },
		{ header = "Kaelaehted", txt = "Kaelaehte müügi valikud", params = { event = "jim-mining:JewelSell:Necklace", } },
...
RegisterNetEvent('jim-mining:JewelSell:Emerald', function()
    exports['qb-menu']:openMenu({
		{ header = "Juveeli Müügimees", txt = "Müü oma juveele siin", isMenuHeader = true }, 
		{ header = "Smaragd", txt = "Müü $"..Config.SellItems['emerald'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'emerald' } },
		{ header = "Lõikamata Smaragd", txt = "Müü $"..Config.SellItems['uncut_emerald'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'uncut_emerald' } }, 
...
RegisterNetEvent('jim-mining:JewelSell:Ruby', function()
    exports['qb-menu']:openMenu({
		{ header = "Juveeli Müügimees", txt = "Müü oma juveele siin", isMenuHeader = true }, 
		{ header = "Rubiin", txt = "Müü $"..Config.SellItems['ruby'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'ruby' } },
		{ header = "Lõikamata Rubiin", txt = "Müü $"..Config.SellItems['uncut_ruby'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'uncut_ruby' } },
		{ header = "", txt = "⬅ Tagasi", params = { event = "jim-mining:JewelSell", } },
	})
end)
...
RegisterNetEvent('jim-mining:JewelSell:Diamond', function()
    exports['qb-menu']:openMenu({
		{ header = "Juveeli Müügimees", txt = "Müü oma juveele siin", isMenuHeader = true }, 
		{ header = "Teemant", txt = "Müü $"..Config.SellItems['diamond'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'diamond' } },
		{ header = "Lõikamata Teemant", txt = "Müü $"..Config.SellItems['uncut_diamond'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'uncut_diamond' } },
		{ header = "", txt = "⬅ Tagasi", params = { event = "jim-mining:JewelSell", } },
	})
end)
...
RegisterNetEvent('jim-mining:JewelSell:Sapphire', function()
    exports['qb-menu']:openMenu({
		{ header = "Juveeli Müügimees", txt = "Müü oma juveele siin", isMenuHeader = true }, 
		{ header = "Safiir", txt = "Müü $"..Config.SellItems['sapphire'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'sapphire' } },
		{ header = "Lõikamata Safiir", txt = "Müü $"..Config.SellItems['uncut_sapphire'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'uncut_sapphire' } },
		{ header = "", txt = "⬅ Tagasi", params = { event = "jim-mining:JewelSell", } },
	})
end)
...
RegisterNetEvent('jim-mining:JewelSell:Rings', function()
    exports['qb-menu']:openMenu({
		{ header = "Juveeli Müügimees", txt = "Müü oma juveele siin", isMenuHeader = true }, 
		{ header = "Kuldsõrmus", txt = "Müü $"..Config.SellItems['gold_ring'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'gold_ring' } },
		{ header = "Teemantsõrmus", txt = "Müü $"..Config.SellItems['diamond_ring'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'diamond_ring'} },
		{ header = "Smaragdsõrmus", txt = "Müü $"..Config.SellItems['emerald_ring'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'emerald_ring' } },
		{ header = "Rubiinsõrmus", txt = "Müü $"..Config.SellItems['ruby_ring'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'ruby_ring' } },	
		{ header = "Safiirsõrmus", txt = "Müü $"..Config.SellItems['sapphire_ring'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'sapphire_ring' } },
		{ header = "", txt = "⬅ Tagasi", params = { event = "jim-mining:JewelSell", } },
	})
end)
...
RegisterNetEvent('jim-mining:JewelSell:Necklace', function()
    exports['qb-menu']:openMenu({
		{ header = "Juveeli Müügimees", txt = "Müü oma juveele siin", isMenuHeader = true }, 
		{ header = "Gold Chains",	txt = "Müü $"..Config.SellItems['goldchain'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'goldchain' } },
		{ header = "Gold Chains", txt = "Müü $"..Config.SellItems['10kgoldchain'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = '10kgoldchain' } },
		{ header = "Diamond Necklace", txt = "Müü $"..Config.SellItems['diamond_necklace'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'diamond_necklace' } },
		{ header = "Emerald Necklace", txt = "Müü $"..Config.SellItems['emerald_necklace'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'emerald_necklace' } },
		{ header = "Ruby Necklace", txt = "Müü $"..Config.SellItems['ruby_necklace'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'ruby_necklace' } },	
		{ header = "Sapphire Necklace", txt = "Müü $"..Config.SellItems['sapphire_necklace'].." tükk", params = { event = "jim-mining:SellAnim:Jewel", args = 'sapphire_necklace' } },
...
RegisterNetEvent('jim-mining:SmeltMenu', function()
	...
	{ header = "Sulata Terast", txt = "Sulata rauamaaki ja süsiniku teraseks", params = { event = "jim-mining:Smelting:Begin", args = 4 } },
	{ header = "", txt = "✘ Sulge", params = { event = "jim-mining:SellAnim", args = -2 } },
...
RegisterNetEvent('jim-mining:JewelCut', function()
    exports['qb-menu']:openMenu({
	{ header = "Kalliskivi lõikelaud", txt = "Vaja käsipuuri ja puuriotsikut", isMenuHeader = true },
	{ header = "Kalliskivid",	txt = "Mine kalliskivi lõikamise menüüsse", params = { event = "jim-mining:JewelCut:Gem", } },
	{ header = "Sõrmused", txt = "Mine sõrmuse lõikamise menüüsse", params = { event = "jim-mining:JewelCut:Ring", } },
	{ header = "Kaelaehted", txt = "Mine kaelaehte lõikamise menüüsse", params = { event = "jim-mining:JewelCut:Necklace", } },
	{ header = "", txt = "✘ Sulge", params = { event = "jim-mining:SellAnim", args = -2 } },
	})
end)
--Gem Section
RegisterNetEvent('jim-mining:JewelCut:Gem', function()
    exports['qb-menu']:openMenu({
	{ header = "Kalliskivi lõikelaud", txt = "Vaja käsipuuri ja puuriotsikut", isMenuHeader = true },
	{ header = "Smaragd", txt = "Lõika, et tõsta hinda", params = { event = "jim-mining:Cutting:Begin", args = 1 } },
	{ header = "Rubiin", txt = "Lõika, et tõsta hinda", params = { event = "jim-mining:Cutting:Begin", args = 2 } },
	{ header = "Teemant", txt = "Lõika, et tõsta hinda", params = { event = "jim-mining:Cutting:Begin", args = 3 } },
	{ header = "Safiir", txt = "Lõika, et tõsta hinda", params = { event = "jim-mining:Cutting:Begin", args = 4 } },
...
RegisterNetEvent('jim-mining:JewelCut:Ring', function()
    exports['qb-menu']:openMenu({
	{ header = "Kalliskivi lõikelaud", txt = "Vaja käsipuuri ja puuriotsikut", isMenuHeader = true },
	{ header = "Kuldsõrmus x3", txt = "Vaja 1 Kullakang", params = { event = "jim-mining:Cutting:Begin", args = 5 } },
	{ header = "Teemantsõrmus", txt = "Vaja 1 Kuldsõrmus & 1 Teemant", params = { event = "jim-mining:Cutting:Begin", args = 6 } },
	{ header = "Smaragdsõrmus", txt = "Vaja 1 Kuldsõrmus & 1 Smaragd", params = { event = "jim-mining:Cutting:Begin", args = 7 } },
	{ header = "Rubiinsõrmus", txt = "Vaja 1 Kuldsõrmus & 1 Rubiin", params = { event = "jim-mining:Cutting:Begin", args = 8 } },
	{ header = "Safiirsõrmus", txt = "Vaja 1 Kuldsõrmus & 1 Safiir", params = { event = "jim-mining:Cutting:Begin", args = 9 } },
	{ header = "", txt = "⬅ Tagasi", params = { event = "jim-mining:JewelCut", } },
	})
end)
--Necklace Section
