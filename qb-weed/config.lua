...
Config.GrowthIncrease = {min = 5, max = 12}

Config.YieldRewards = {
    {type = "purple-haze", rewardMin = 2, rewardMax = 5, item = 'weed_purple-haze', label = 'Purple Haze 2G'},
    {type = "og-kush", rewardMin = 2, rewardMax = 5, item = 'weed_og-kush', label = 'OGKush 2G'},
    {type = "white-widow", rewardMin = 2, rewardMax = 5, item = 'weed_white-widow', label = 'White Widow 2G'},
    {type = "skunk", rewardMin = 2, rewardMax = 5, item = 'weed_skunk', label = 'Skunk 2G'},
    {type = "amnesia", rewardMin = 2, rewardMax = 5, item = 'weed_amnesia', label = 'Amnesia 2G'},
    {type = "ak47", rewardMin = 2, rewardMax = 5, item = 'weed_ak47', label = 'AK47 2G'},
}

Config.MaxPlantCount = 12

Config.BadSeedReward = "weed_skunk_seed"
